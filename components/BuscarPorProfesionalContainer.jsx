...
export default function BuscarPorProfesionalContainer({ onProfesionalSeleccionado }) {
      ...
      {search.length > 1 && (
        <div>
          {profesionalesFiltrados.length === 0 ? (
            <div className="mt-3 text-gray-500 text-center">No se ha encontrado ningún profesional.</div>
          ) : (
